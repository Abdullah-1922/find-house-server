...
exports.PropertyPaymentController = void 0;
const http_status_1 = __importDefault(require("http-status"));
const catchAsync_1 = __importDefault(require("../../utils/catchAsync"));
const sendResponse_1 = __importDefault(require("../../utils/sendResponse"));
const propertyPayment_service_1 = require("./propertyPayment.service");
const createPayment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const paymentData = req.body;
    const payment = yield propertyPayment_service_1.PropertyPaymentService.createPayment(paymentData);
...
const getPayments = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { payments, meta } = yield propertyPayment_service_1.PropertyPaymentService.getPayments(req.query);
    (0, sendResponse_1.default)(res, {
...
const getPaymentById = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const payment = yield propertyPayment_service_1.PropertyPaymentService.getPaymentById(id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const updatePropertyPayment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const paymentData = req.body;
    const payment = yield propertyPayment_service_1.PropertyPaymentService.updatePaymentPayment(id, paymentData);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
